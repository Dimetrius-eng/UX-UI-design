...
Це фахівець з глибокою експертизою в одній сфері (наприклад, UI) та базовими знаннями в суміжних (верстка, маркетинг). Це актуально для покращення комунікації в команді та розуміння обмежень колег.

**5.** ***Навіщо потрібен етап "Експорт ресурсів" і що таке UI Kit / Styleguide, який дизайнер передає розробнику?**

Експорт потрібен для передачі графіки розробникам. UI Kit/Styleguide — це документація з набором усіх стилів (кольори, шрифти) та компонентів (кнопки, поля), що забезпечує єдність дизайну в коді.
...
Через технічну складність або недоцільність рішень. Приклад: дизайнер намалював нестандартну анімацію або ефект, який "гальмує" на слабких пристроях, а розробник відмовляється це впроваджувати заради продуктивності.

**7.** ****Як ви вважаєте, чи повинен дизайнер знати основи HTML/CSS? Аргументуйте свою думку (як це допомагає або заважає в роботі).**

Так. Це допомагає розуміти технічні обмеження вебу, створювати макети, які реально зверстати, і говорити з розробниками однією мовою, уникаючи "неможливих" дизайнів.
