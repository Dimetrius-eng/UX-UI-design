...
Відповідно до методології Design Thinking, на етапі дослідження (Research) — я буду працювати у FigJam. Це середовище найкраще підходить для «роботи детектива»: збору відгуків, проведення брейнстормінгів, пошуку root cause проблем через метод «5 Чому» та побудови емпатійних карт. Тут ми створюємо хаос ідей, який потім структуруємо.
На етапі UI (User Interface) — я перейду у Figma. Коли справжню проблему вже визначено (Define), а рішення придумано (Develop) , Figma дозволяє втілити ці ідеї у вигляді точних вайрфреймів та фінального візуального стилю для передачі розробникам.
