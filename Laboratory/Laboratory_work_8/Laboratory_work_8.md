...
- Знайдіть 2–3 приклади інтерфейсів (Behance / Dribbble), які відповідають напрямку вашого проєкту. Проаналізуйте, які типи кнопок, стилі інпутів, чекбокси та радіобатони там використано. Чи можете ви подыбны ідеї використати у своєму проєкті?
