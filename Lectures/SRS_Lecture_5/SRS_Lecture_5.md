...
| :--- | :--- |
| **Primary Color (Акцентний)** <br> <img src = "6.png" width = "200" />| Rausch (насичений рожево-червоний, #E00B41). Згідно з психологією кольору, цей відтінок викликає емоції збудження та любові до пригод. Він використовується виключно для кнопок заклику до дії (наприклад, «Забронювати») та логотипа |
