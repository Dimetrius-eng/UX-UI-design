...
- **Як можна класифікувати інтерфейси?**
  ...
  *__1)CLI (Command Line Interface)__. Чорний екран, білий текст, потрібно знати команди на пам'ять.*   
  *__2)GUI (Graphical User Interface)__. Вікна, іконки, курсор (метафора робочого столу).*   
